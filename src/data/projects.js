export const projects = [
  {
    ...
    featured: true,
    teaserImage: '/img/Ccoi/Ccoi-hp-crop.webp',
    images: ['/img/Ccoi/Ccoi-hp.webp', '/img/Ccoi/Ccoi-plp.webp', '/img/Ccoi/Ccoi-pdp.webp'],
    description: [
  ...
  },
  {
    ...
    title: 'Financial 316',
    featured: true,
    teaserImage: '/img/316/316-hp-crop.webp',
    images: ['/img/316/316-hp.webp', '/img/316/316-page.webp', '/img/316/316-article.webp'],
    description: [
  ...
  },
  {
    ...
    title: 'Develon',
    featured: true,
    teaserImage: '/img/Develon/Develon-hp-crop.webp',
    images: ['/img/Develon/Develon-hp.webp', '/img/Develon/Develon-plp.webp', '/img/Develon/Develop-pdp.webp'],
    description: [
  ...
  },
  {
    ...
    title: 'Marinemax',
    featured: false,
    teaserImage: '/img/Marinemax/Marinemax-hp-crop.webp',
    images: ['/img/Marinemax/Marinemax-hp.webp', '/img/Marinemax/Marinemax-store.webp','/img/Marinemax/Marinemax-filter.webp', '/img/Marinemax/Marinemax-plp.webp'],
    description: [
  ...
  },
  {
    ...
    title: 'Lamar',
    featured: true,
    teaserImage: '/img/Lamar/Lamar-hp-crop.webp',
    images: ['/img/Lamar/Lamar-hp.webp', '/img/Lamar/Lamar-form.webp', '/img/Lamar/Lamar-locations.webp'],
    description: [
  ...
  },
  {
    ...
    teaserImage: '/img/cannondale-hp.webp',
    description: [
  ...
  //   title: 'MomentUs',
  //   featured: false,
  //   teaserImage: '/img/momentus-hp.webp',
  ...
  //   title: 'Vacation.com',
  //   featured: false,
  //   teaserImage: '/img/vacation-hp.webp',
